...
<html>
    ...
    <head>
        <title>CovidPage_1302194003</title>
        <!--Meta tags-->
        <meta charset="utf-8">
    ...
    <body>
		...
		<div class="container-fluid bg-white" id="card-car" style="margin-bottom: 1%; width: 70%; border-radius: 10px;">
			<br>
		<div id="accordion">
			<button class="btn btn-primary" data-toggle="collapse" data-target="#multiCollapseExample1" aria-expanded="false" aria-controls="multiCollapseExample2">Lokasi Vaksinasi</button>
			<button class="btn btn-primary" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Lokasi Tes PCR & Antigen</button>
			<button class="btn btn-primary" data-toggle="collapse" data-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample2">Sertifikat Vaksin</button>
			</p><hr>
			<div class="row">
			<div class="col-md-12">
				<div class="collapse show" id="multiCollapseExample1" data-parent="#accordion">
					<div class="container">
						<h1 style="text-align: left;">Lokasi Vaksinasi</h1><br>
						<?php 
							foreach($dataVaksinasi as $data){		
								echo"<div class='card' style='border-radius:6px; border-width:1px;'>
								<div class='card-header' style='border-width:1px; border-bottom: 4.5px solid #28A0EB'>
									<h5 style='font-size:20px; padding-left:15px; float:left;'>".$data['namaTempat']."</h2>
									<h5 style='font-size:20px; float:right;'>".$data['kontak']."</h5>
										<img src='assets/Contact.png' style='width:25px; height:25px; float:right; margin-right:10px;'><br><hr>
										<img src='assets/Location.png' style='width:25px; height:25px; float:left; margin-right:10px;'>
									<h5 style='font-size:15px; float:left;'>".$data['lokasi']."</h5>
								</div>
								</div>
							<br>";
						}?>
			...
			<div class="col-md-12">
				<div class="collapse" id="multiCollapseExample2" data-parent="#accordion">
					<div class="container">
						<h1 style="text-align: left;">Lokasi Tes PCR & Antigen</h1><br>
						<?php 
							foreach($dataTes as $data){		
								...
								<div class='card-header' style='border-width:1px; border-bottom: 4.5px solid #28A0EB'>
									...
									<h5 style='font-size:20px; float:right;'>".$data['kontak']."</h5>
										<img src='assets/Contact.png' style='width:25px; height:25px; float:right; margin-right:10px;'><br><hr>
										<img src='assets/Location.png' style='width:25px; height:25px; float:left; margin-right:10px;'>
									<h5 style='font-size:13px; float:left; padding-left:5px;'>".$data['lokasi']."</h5>
									<h5 style='font-size:16px; float:right; padding-left:5px; color:#22A7F0;'>".$data['jenis']."</h5>
								</div>
								</div>
							<br>";
						}?>
			...
			<div class="col-md-12">
				<div class="collapse" id="multiCollapseExample3" data-parent="#accordion">
					<div class="container">
						<h1 style="text-align: left;">Sertifikat Vaksin</h1><br>
						<?php 
							$i = 1; 
							foreach($dataSertifikat as $data){		
								...
								<div id='accordion2'>
									...
									style='border-width:1px; border-bottom: 4.5px solid #28A0EB' aria-expanded='true' aria-controls='collapseOne'>
										<h5 style='font-size:20px; padding-left:15px; float:left; color:#22A7F0;'>Vaksin ke-".$data['dosis']."</h2>
									...
									<div id='collapse".$i."' class='collapse' aria-labelledby='headingOne' data-parent='#accordion2'>
										<div class='card-body'>
											<img src='assets/sertifikat/".$data['urlSertif'].".jpg' alt='Vaksin ke-".$data['dosis']."' style='width:600px; height:300px; 
											display: block; margin-left: auto; margin-right: auto;'>
											<h5 style='font-size:18px; text-align:center;'>".$data['nik']."</h5>
											<a download href='assets/sertifikat/".$data['urlSertif'].".jpg' class='btn btn-primary' style='float:right;'>Unduh</a><br>
										</div>
									</div>
									</div>
								</div>
