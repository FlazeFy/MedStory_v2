...
<html>
    ...
    <body>
        ...
        <div id="Navigation">
            <ul>
                ...
                <li><a class="nav-link scrollto">SmartDoc</a></li>
                <li><a class="nav-link scrollto">Forum</a></li>
                <li><a class="nav-link scrollto">Dataku</a></li>
				<li><a class="nav-link scrollto">Darurat</a></li>
                <li style="float:right; margin:5px;"><a class="nav-link scrollto rounded" data-toggle="collapse" 
					data-target="#multiCollapseExample3" type="button">Masuk <i class="fa fa-sign-in mr-2"></i></a>
				</li>
                <div id="ddParent">
			...
			<div class="container" id="myGroup">
				<div class="row m-2 pl-5">
					<div class="col-lg-6 d-flex flex-column justify-content-center">
						...
						<p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Interdum velit laoreet id donec ultrices tincidunt arcu non. Mus mauris vitae ultricies.</p>
						...
						<!--Error Message-->
						<p id="msgError"><?= $this->session->flashdata('error_create')?> <?= $this->session->flashdata('error_gambar')?></p>						
					</div>
					<div class="collapse show" id="multiCollapseExample1">
						<div class='container-fluid'>
							<img class="m-2" width="400" src="http://localhost/MedStory/assets/icon/Welcome.gif" alt="Welcome.gif">
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-3">
									...
									<div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
										...
										<i class="fa fa-book mr-2"></i><span class="font-weight-bold small text-uppercase">Privasi dan Kebijakan</span></a>
										<a class="nav-link mb-3 p-3 shadow" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
										<i class="fa fa-photo mr-2"></i><span class="font-weight-bold small text-uppercase">Foto Profil</span></a>
										<a class="nav-link mb-3 p-3 shadow" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
										<i class="fa fa-id-card mr-2"></i><span class="font-weight-bold small text-uppercase">Data Diri</span></a>
										<a class="nav-link mb-3 p-3 shadow" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
										<i class="fa fa-user mr-2"></i><span class="font-weight-bold small text-uppercase">Data Akun</span></a>
									</div>
								</div>
								...
								<div class="col-md-9">
									...
									<div class="tab-content" id="v-pills-tabContent">
										...
										<div class="tab-pane fade shadow rounded bg-white show active p-5" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
											<h5>Privasi dan Kebijakan</h5>
											<p class="font-italic text-muted" style='font-size:15px;'> 
												<input required type="checkbox" name="agree" value="yes" style='width:30px;'>
										...
										<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
											...
											<div class="d-flex flex-column align-items-center text-center p-3">
												<img src="http://localhost/Medstory/assets/defaultImg.png" alt="Admin" class="rounded-circle img-fluid" width="200px" id="frame">
											</div>
											<div class="row">
												<div class="col-md-6">
													<div class="input-group mb-3">
														...
														<div class="custom-file">
															<input type="file" class="custom-file-input" id="uploadImage" onchange="preview()" name="uploadImage" accept='image/*' required>
															<label class="custom-file-label text-left">max 1 mb</label>
														</div>
													</div>
												</div>
												<div class="col-md-5">
													<button onclick="clearImage()" class="btn btn-danger">Reset</button>
												</div>
											</div>
										</div>
										...
										<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
											...
											<div class="row mt-2">
												<div class="col-md-12">
													<h6 >Nama Lengkap</h6>
													<input required type="fullname" class="form-control" name="fullname">
												</div>                            
												<div class="col-md-12">
										...
										<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
											...
											<div class="row mt-2">
												...
												<div class="col-md-12">
													<h6>Nomor Ponsel</h6>
													<input required type="phone" class="form-control" name="ponsel">
												</div>
												<div class="col-md-12">
													<h6>Password</h6>
												...
												<div class="col-md-12">
													...
													<div class="form-group mb-3">
														<button class="btn btn-success w-100" type="submit" onclick="cekAkun()">Submit <i class="fa fa-send-o mr-2"></i></button>
													</div>
												</div>	
											</div>									
										</div>
					...
					<form method="post" class="signin-form" action="landing/savedata">
						...
						<div class="row justify-content-center" >
							<div class="col"style='max-width:500px;'>
								...
								<!--Error Message-->
								<h5 id="msgError"><?= $this->session->flashdata('error_login'); ?></h5>
								<div class="form-group mb-3">
									<button class="btn btn-success w-100" type="submit" name="save">Submit</button>
								</div>
								<div class="form-group d-md-flex">
									<div class="w-50 text-left">
										<label class="checkbox-wrap checkbox-primary mb-0"><input type="checkbox" checked style='margin-right:5px;'>
											<span class="checkmark"></span></label>Ingat saya
									</div>
									<div class="w-50 text-right">
										<button class="btn btn-link" type="button" style='text-decoration: underline;'>Lupa Password</button>
									</div>
								</div>
		...
		<section>
			<div class="container" data-aos="fade-up">
				<header class="section-header"><h1>Fitur kami</h1></header>
				<div class="row">
					<div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
						<div class="box">
							<img src="http://localhost/MedStory/assets/icon/SmartDoc.gif" class="img-fluid">
							<h3>SmartDoc</h3>
					...
					<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
						<div class="box">
							<img src="http://localhost/MedStory/assets/icon/Diskusi.gif" class="img-fluid">
							<h3>Forum</h3>
					...
					<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
						<div class="box">
							<img src="http://localhost/MedStory/assets/icon/DataKu.gif" class="img-fluid">
							<h3>DataKu</h3>
					...
					<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
						<div class="box">
							<img src="http://localhost/MedStory/assets/icon/Darurat.gif" class="img-fluid">
							<h3>Darurat</h3>
							<p>Quam rem vitae est autem molestias explicabo debitis sint. Vero aliquid quidem commodi.</p>
						</div>
					</div>
					...
					<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
						<div class="box">
							<img src="http://localhost/MedStory/assets/icon/HealthFeeds.gif" class="img-fluid">
							<h3>Health Feeds</h3>
							<p>Quam rem vitae est autem molestias explicabo debitis sint. Vero aliquid quidem commodi.</p>
						</div>
					</div>
				...
				<div class="container-fluid" style='margin-top:20px;'>
					<?php 
						foreach($dataUpdate as $data){
							echo "<p class='text-center'>".$data['tanggal']." (".$data['jam'].") || ".$data['deskripsi']."</p>";
						} 
					?>
				</div>
			</div>
	...
	<?php 
		if(isset($errorLogin)) { 
			echo"<div class='modal fade' id='errorLogin' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
			<div class='modal-dialog' role='document'>
				<div class='modal-content'>
				<div class='modal-header'>
	...
	<script type="text/javascript">
		...
		function clearImage() {
			...
			frame.src = "http://localhost/Medstory/assets/defaultImg.png";
		}
	</script>
